...
class AkunPegawai extends StatefulWidget {
  @override
  _AkunPegawaiState createState() => _AkunPegawaiState();
}

class _AkunPegawaiState extends State<AkunPegawai> {
                      ...
                      onPressed: () async {
                         if (_formKey.currentState.validate()) {
                            FirebaseAuth.instance.createUserWithEmailAndPassword(
                              email: _email.text, 
                              password: _password.text).then((currentUser) => Firestore.instance.collection('pegawai')
