...
class DetailSuratKeluar extends StatefulWidget {
  ...
  const DetailSuratKeluar({Key key, this.documentId, this.ditujukanKepada, this.nomorSurat, this.perihalSurat, this.tanggalSurat, this.imageName}) : super(key: key);
