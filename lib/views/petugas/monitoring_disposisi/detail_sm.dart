...
import 'package:disposur/views/petugas/monitoring_disposisi/cetak_detail_sm.dart';
             ...
             IconButton(
                ...
                onPressed: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => CetakDetailSM(
                                      uid: widget.uid,
                                      jabatan: widget.jabatan,
                                      pengirimSurat: widget.pengirimSurat,
                                      ...
                                      nomorAgenda: widget.nomorAgenda,
