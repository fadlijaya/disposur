...
class DetailSuratMasuk extends StatefulWidget {
  ...
  const DetailSuratMasuk({Key key, this.documentId, this.pengirimSurat, this.nomorSurat, this.perihalSurat, this.tanggalSurat, this.diterimaTanggal, this.nomorAgenda, this.imageName, this.title,}) : super(key: key);
